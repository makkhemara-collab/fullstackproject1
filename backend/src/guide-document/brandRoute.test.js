...
curl -X GET "https://fullstackproject1-1-dzlc.onrender.com/api/brand/search?keyword=samsung"

// Get all brands
curl -X GET "https://fullstackproject1-1-dzlc.onrender.com/api/brand"

// Get specific brand by code
curl -X GET "https://fullstackproject1-1-dzlc.onrender.com/api/brand?code=BRAND001"

// Create new brand
curl -X POST "https://fullstackproject1-1-dzlc.onrender.com/api/brand" \
  -H "Content-Type: application/json" \
  -d '{"code":"BRAND004","desc":"LG","category_id":"CAT001","remark":"Electronics","photo":"lg_logo.png"}'

// Update brand
curl -X PUT "https://fullstackproject1-1-dzlc.onrender.com/api/brand/BRAND001" \
  -H "Content-Type: application/json" \
  -d '{"desc":"Samsung New","remark":"Updated","photo":"samsung_updated.png"}'

// Delete brand
curl -X DELETE "https://fullstackproject1-1-dzlc.onrender.com/api/brand/BRAND001"
*/
